...
// CreateAEntries mocks base method.
func (m *MockStore) CreateAEntries(arg0 context.Context, arg1 db.CreateAEntriesParams) (db.Entries, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateAEntries", arg0, arg1)
	ret0, _ := ret[0].(db.Entries)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// CreateAEntries indicates an expected call of CreateAEntries.
func (mr *MockStoreMockRecorder) CreateAEntries(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateAEntries", reflect.TypeOf((*MockStore)(nil).CreateAEntries), arg0, arg1)
}
